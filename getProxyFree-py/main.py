...
def update_title():
    ...
    if platform.system() == 'Darwin':  # Kiểm tra xem hệ điều hành có phải là macOS không
        subprocess.run(['osascript', '-e', f'tell application "Terminal" to set custom title of window 1 to "[ LunusBPS ] By H4cK3dR4Du & 452b | HTTP/s Scraped : {https_scraped} ~ Socks4 Scraped : {socks4_scraped} ~ Socks5 Scraped : {socks5_scraped}"'])

def update_title2():
    global https_scraped, socks4_scraped, socks5_scraped
    if platform.system() == 'Darwin':  # Kiểm tra xem hệ điều hành có phải là macOS không
        subprocess.run(['osascript', '-e', f'tell application "Terminal" to set custom title of window 1 to "[ LunusBPS ] By H4cK3dR4Du & 452b | HTTP/s Valid : {http_checked} ~ Socks4 Valid : {socks4_checked} ~ Socks5 Valid : {socks5_checked}"'])
